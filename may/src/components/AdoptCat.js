...
class AdoptCat extends Component{
            ...
            if(animal.category=== 'cat'){
                return(
                    <div class="card" key={animal.id}>
                        ...
                        <Link to ={`/adopt/${animal.id}`}class="ui negative basic button">More about cat</Link>
                    </div>
    ...
    render(){
        return(
            ...
            <div>
                <div className="ui horizontal segment" style={{backgroundColor:"#D59C72",color:"white",fontFamily:"Proxima Nova" }}> 
                    <h1  className="ui center aligned header" style={{fontFamily:"Proxima Nova" ,fontSize:"5em",color:"white"}}>
                        CATS FOR ADOPTION
                    </h1>
                    <h3 className="ui left aligned header"style={{fontSize:"2em",color:"white"}}>
                        WALK-INS ACCEPTED
                    </h3>
                ...
                <div className="ui huge breadcrumb">
                    ...
                    <div className="active section">Adopt a cat</div>
                </div>
                <h2 className="ui center aligned header"style={{fontSize:"2em",color:"#D59C72"}}>Adoptable Cats Updated as of Thursday 03:24 am</h2>
...
export default connect (mapStateToProps,{ fetchAnimals })(AdoptCat);